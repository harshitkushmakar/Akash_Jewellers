...
public class AdminMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.DrawerLayout ),
                (v, insets) -> {
        ...
        imageButton = findViewById(R.id.drawerButtonToggle);
        ...
        currentTimeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(AdminMainActivity.this, "Display time updated", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        priceUpdateNodeReference.setValue(priceData)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(AdminMainActivity.this, "Prices updated successfully!", Toast.LENGTH_SHORT).show();
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(AdminMainActivity.this, "Failed to update: " + e.getMessage(), Toast.LENGTH_LONG).show();
        ...
        executorService.execute(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    if (accessToken == null) {
                        runOnUiThread(() -> Toast.makeText(AdminMainActivity.this,
